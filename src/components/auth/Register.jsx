                ...
                <div className='bg-blue-50 px-5  border rounded-xl border-blue-50 '>
                    ...
                    <div className="flex flex-row space-x-4 space-y-3">
                        <div className='w-1/2 text-blue-800 '>
                            ...
                            <Input type="text" placeholder="Jean" id="prenom" name="prenom" className = "focus:border-blue-500  w-full  h-10  rounded-xl p-3 font-semibold" />
                        </div>

                        <div className='w-1/2  text-blue-800 '>
                            <label htmlFor="prenom" className='text-blue-900 font-semibold' >Nom</label>
                            <Input type="text" placeholder="Dupont" id="nom" name="nom" className = " focus:ring-2 focus:ring-blue-500  w-full  h-10   rounded-xl p-3 font-semibold-[10px] " />
                        </div>
                    </div>
                    ...
                    <div className='flex left flex-col space-y-2  text-blue-800 '>
                        ...
                        <div className=" flex flex-col space-y-2 ">
                                ...
                                <Input type="email" placeholder="votre@email.com" id ="email" name="email" className = "focus:border-blue-500 w-full  h-10    rounded-xl p-3 font-semibold-[10px] " />
                        </div>

                        <div className=" flex flex-col space-y-2 ">
                                <label htmlFor="telephone" className='text-blue-900 font-semibold' >Numero  de téléphone</label>
                                <Input type="text" placeholder="+33 45 25 45 78 08" id="telephone" name="telephone" className = "focus:border-blue-500 w-full  h-10 rounded-xl p-3 font-semibold-[10px] " />
                        </div>

                        <div className=' flex flex-col space-y-3 '>
                                <label htmlFor="password" className='text-blue-900 font-semibold' >Mot de passe</label>
                                <Input type="password" placeholder=".........." id="password" name="password" className = "focus:border-blue-500 w-full  h-10   rounded-xl p-3 font-semibold-[10px] " />
                        </div>

                        <div className=' flex flex-col space-y-3 ' >
                                <label htmlFor="confirm_password" className='text-blue-900 font-semibold' >Confirmer le mot de passe</label>
                                <Input type="password" placeholder=".........." id="confirm_password" name="password" className = "focus:border-blue-500 w-full  h-10  rounded-xl p-3 font-semibold-[10px] " />
                        </div>
                        ...
                        <div className='flex flex-row justify-center gap-4'>
                            <Button className="rounded-xl ">Google</Button>
                            <Button className="rounded-xl ">facebook</Button>
                        </div>
